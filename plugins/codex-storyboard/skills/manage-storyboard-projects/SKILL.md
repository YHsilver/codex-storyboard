...
```text
【主体】：@[主体图/主体音频]，写主体素材引用与配件规则。默认情况下所有出镜人物佩戴头盔，雪镜架在头盔上；进入滑雪或下滑执行状态时，佩戴头盔，雪镜戴在脸上。主体段仅写人物素材引用与头盔、雪镜等配件信息。
...
- 【主体】优先使用 `subjectAssetRefs` 对应的主体人物或声音参考；主体段只写主体素材引用和配件规则，不写表演状态、情绪或表情。默认情况下人物佩戴头盔，雪镜架在头盔上；滑雪或下滑执行状态时，雪镜戴在脸上。
- 【场景】只描述环境，包括地点、时间、天气、光线、雪道、室内陈设和空间关系；不要写人物、动作、道具特写、台词、情绪或表演。
